...
#ifdef DBCS
static unsigned char *sk1, *sk2;
static dbchar *db1, *db2;
#endif
...
#ifdef DBCS
		sk1 = (*a)->sksf[i]; sk2 = (*b)->sksf[i];
		db1 = (*a)->dbsf[i]; db2 = (*b)->dbsf[i];
#endif
...
#ifdef DBCS
		sk1 = (*a)->skaf[i]; sk2 = (*b)->skaf[i];
		db1 = (*a)->dbaf[i]; db2 = (*b)->dbaf[i];
#endif
...
static int
compare_string(unsigned char *x, unsigned char *y)
{
    int     i = 0;
    int     j = 0;
	unsigned char *a, *b;
...
#ifdef DBCS
					sk1 = (*a)->skencap; sk2 = (*b)->skencap;
					db1 = (*a)->dbencap; db2 = (*b)->dbencap;
#endif
