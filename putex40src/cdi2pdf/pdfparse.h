/*  $Header: /cvsroot/miktex/miktex/dvipdfmx/pdfparse.h,v 1.1 2003/12/27 18:03:16 csc Exp $
...
extern char *parse_dbcs_name (char **start, char *end);
...
extern pdf_obj *parse_pdf_hex_string (char **start, char *end);
