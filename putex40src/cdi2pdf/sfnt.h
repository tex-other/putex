/*  $Header: /cvsroot/miktex/miktex/dvipdfmx/sfnt.h,v 1.1 2003/12/27 18:03:16 csc Exp $
...
extern ULONG sfnt_find_table_len (sfnt *sfont, char *tag);
extern ULONG sfnt_find_table_pos (sfnt *sfont, char *tag);
extern ULONG sfnt_locate_table (sfnt *sfont, char *tag);

extern void  sfnt_set_table (sfnt *sfont, char *tag, char *data, ULONG length);
extern int   sfnt_require_table (sfnt *sfont, char *tag, int must_exist);
