/*  $Header: /cvsroot/miktex/miktex/dvipdfmx/pst_obj.h,v 1.1 2003/12/27 18:03:16 csc Exp $
...
extern int     pst_name_is_valid (unsigned char *name);
extern unsigned char *pst_name_encode   (unsigned char *name);
