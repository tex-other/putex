/*  $Header: /cvsroot/miktex/miktex/dvipdfmx/cid.c,v 1.1 2003/12/27 18:03:16 csc Exp $
...
static struct {
  ...
  {"AU",     0}, {"AG1",    1}, {"AC1",    2}, {"AJ1",    3}, {"AK1",    4},
  {"UCS",    0}, {"GB1",    1}, {"CNS1",   2}, {"Japan1", 3}, {"Korea1", 4},
  {"U",      0}, {"G",      1}, {"C",      2}, {"J",      3}, {"K",      4},
  {NULL,     0}
};
...
static int CIDFont_base_open (CIDFont *font, char *name, CIDSysInfo *cmap_csi, cid_opt *opt);

static int
CIDFont_base_open (CIDFont *font, char *name, CIDSysInfo *cmap_csi, cid_opt *opt)
{
...
static int
try_default (CIDFont *font, char *map_name, CIDSysInfo *cmap_csi, cid_opt *opt)
{
  int i;
...
{
  char *name;
  char *p = (char *) map_name, *next = NULL;
