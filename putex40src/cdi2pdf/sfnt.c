/*  $Header: /cvsroot/miktex/miktex/dvipdfmx/sfnt.c,v 1.1 2003/12/27 18:03:16 csc Exp $
...
static int find_table_index (struct sfnt_table_directory *td, char *tag)
{
  int idx;
...
void sfnt_set_table (sfnt *sfont, char *tag, char *data, ULONG length)
{
...
ULONG sfnt_find_table_len (sfnt *sfont, char *tag)
{
  struct sfnt_table_directory *td;
  int idx;
  ULONG result = 0;
...
ULONG sfnt_find_table_pos (sfnt *sfont, char *tag) 
{
  struct sfnt_table_directory *td;
  int idx;
  ULONG result = 0;
...
ULONG sfnt_locate_table(sfnt *sfont, char *tag)
{
  ULONG offset;
...
int sfnt_require_table (sfnt *sfont, char *tag, int must_exist)
{
  int status = 0;
  struct sfnt_table_directory *td;
  int idx;
